...
awful.screen.connect_for_each_screen(function(s)
    ...
    --fill right widget area
    mywidgets = { layout = wibox.layout.fixed.horizontal,}
    for i = #widgets, 1, -1 do
	table.insert(mywidgets, widgets[i])
    end
    table.insert(mywidgets, s.mylayoutbox)

    gears.table.join(layout)
...
awful.rules.rules = {
    ...
    { rule = { class = "Pidgin" },
       properties = { screen = 1, tag = "im", switchtotag = true } },
